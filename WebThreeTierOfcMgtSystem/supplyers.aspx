...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Add Supplyer</h4>
                            </div>
                        </div>
                    </div>
    ...
    <p>
        ...
        <table style="width:100%; margin-top: 0px;">
            <tr>
                <td style="height: 22px; width: 162px">Sup ID :</td>
                <td style="height: 22px; width: 577px">
                    <asp:TextBox ID="txt_sid" class="form-control" runat="server" Width="370px"></asp:TextBox>
                </td>
